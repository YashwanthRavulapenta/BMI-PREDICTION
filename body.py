...
# 7. Violin Plot for BMI Distribution by Gender
plt.figure(figsize=(8, 6))
sns.violinplot(x='Gender', y='BMI', data=data, palette='muted')
plt.title("BMI Distribution by Gender", fontsize=16)
plt.xlabel("Gender (0: Female, 1: Male)", fontsize=14)
plt.ylabel("BMI", fontsize=14)
plt.show()

# Residual Distribution Analysis for a Model
...
plt.figure(figsize=(8, 6))
sns.histplot(residuals, bins=20, kde=True, color='purple', alpha=0.6)
